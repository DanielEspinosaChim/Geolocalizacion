...
## Corpus Check
- 216 files · ~45,331 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 869 nodes · 1667 edges · 42 communities (37 shown, 5 thin omitted)
...
Cohesion: 0.14
Nodes (13): Badge(), BadgeProps, BadgeTone, TONE_CLASSES, PanelSection(), PanelSectionProps, Table(), TableProps (+5 more)
...
Cohesion: 0.08
Nodes (30): ErrorBoundary, State, rootElement, activarAppCheck(), getFirebaseAuth(), EVENTOS, vigilarInactividad(), changePassword() (+22 more)
...
Cohesion: 0.08
Nodes (33): GuardarVisitaInput, useGuardarVisita(), PlantillaInput, usePlantillaMutations(), usePlantillas(), CampoEditor(), CampoEditorProps, CampoVisita() (+25 more)
...
Cohesion: 0.11
Nodes (15): Column, DataTable(), DataTableProps, paginar(), columnas, Fila, filas, useFiltrado() (+7 more)
...
Cohesion: 0.07
Nodes (25): ERROR_MESSAGES, SignInError, signInWithEmail(), signInWithGoogle(), SILENT_CODES, translate(), renderDetalle(), GoogleIcon() (+17 more)
...
## Knowledge Gaps
- **231 isolated node(s):** `singleQuote`, `semi`, `printWidth`, `trailingComma`, `plugins` (+226 more)
...
- **Why does `useConfirm()` connect `Community 24` to `Community 0`, `Community 32`, `Community 26`, `Community 46`?**
  _High betweenness centrality (0.293) - this node is a cross-community bridge._
- **Why does `CampanaDetalle()` connect `Community 0` to `Community 24`?**
  _High betweenness centrality (0.230) - this node is a cross-community bridge._
- **Why does `useCandidatos()` connect `Community 27` to `Community 0`, `Community 33`, `Community 29`?**
